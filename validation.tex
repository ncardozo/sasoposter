...
more tasks completed than the control group (\fref{fig:completionCollaborative}). On top of that, they 
also spent significantly less time performing actions related to version control, an average of $33.2$  
minutes less (\fref{fig:versionControlCollaborative}). The higher completion rate achieved by the groups 
...
developers finished an average of $4\%$ more tasks (\fref{fig:completionProductLine}) and spent 
$2.83$ minutes less in version control than the developers using Eclipse 
(\fref{fig:versionControlProductLine}). The process of creating new product variants and their 
