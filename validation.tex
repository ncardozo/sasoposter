...
The objective of this experiment was to quantify the overhead reduction that can be achieved with CollabIDE in a distributed development project where team members must constantly use version control to guarantee their code is up to date. 
