...
\end{ctxtraits}
\\
Having defined a context, all code increments are stored as a 
behavioral adaptation associated to such context as shown next:
\begin{ctxtraits}
 var increments = {};
 var OwnerTrait = Trait({
	...
 	// Trait definition for code ownership
	...
	this.proceed();
 	}
 });
190520171428.adapt(increments, OwnerTrait);
\end{ctxtraits}
\\
