...
for distributed development teams working on a software project. \fref{fig:general-view} shows the general view of a project created with the IDE. 
...
updated) version of the code at all times. Moreover, when switching between versions, developers have an 
immediate view of the complete state of the code at the moment the version was created or edited. 

\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.6\textwidth]{img/fig4-collabIDEVersionManagement}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{img/fig3-collabIDEContributionManagement}
